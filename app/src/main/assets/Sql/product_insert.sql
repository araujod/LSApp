...
INSERT INTO Product (Name,Description,Category,PictureURL,Price,Highlight) VALUES
  ...
  ('Moet & Chandon Ice Imperial', 'Moet & Chandon Ice Imperial Description', 'Wine','Moet&ChandonIceImperial.png',95.99,TRUE),
  ('Laurent-Perrier Brut Champagne', 'Laurent-Perrier Brut Champagne Description', 'Wine','Laurent-PerrierBrutChampagne.png',99.99,FALSE),
  ...
  ('J&BRareBlendedScotch', 'J&BRareBlendedScotch Description', 'Distilled','J&BRareBlendedScotch.png',25.99,FALSE),
